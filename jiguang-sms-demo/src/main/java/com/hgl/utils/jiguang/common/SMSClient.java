package com.hgl.utils.jiguang.common;
...
import com.hgl.utils.jiguang.account.AccountBalanceResult;
import com.hgl.utils.jiguang.account.AppBalanceResult;
import com.hgl.utils.jiguang.common.model.BatchSMSPayload;
import com.hgl.utils.jiguang.common.model.BatchSMSResult;
import com.hgl.utils.jiguang.common.model.SMSPayload;
import com.hgl.utils.jiguang.schedule.model.ScheduleResult;
import com.hgl.utils.jiguang.schedule.model.ScheduleSMSPayload;
import com.hgl.utils.jiguang.schedule.model.ScheduleSMSResult;
import com.hgl.utils.jiguang.template.SendTempSMSResult;
import com.hgl.utils.jiguang.template.TempSMSResult;
import com.hgl.utils.jiguang.template.TemplatePayload;
...
public class SMSClient {
	...
	public SendSMSResult sendVoiceSMSCode(SMSPayload payload)
		...
		cn.jiguang.common.resp.ResponseWrapper response = _httpClient.sendPost(_baseUrl + _voiceCodePath, payload.toString());
		return SendSMSResult.fromResponse(response, SendSMSResult.class);
	}
